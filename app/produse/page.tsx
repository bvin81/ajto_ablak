...
const products = [
  { category: "windows" as Category, image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=500&h=400&fit=crop", detail: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&h=600&fit=crop", nameKey: "windows" as const, detailsRo: "Ferestre PVC cu geam termoizolant dublu sau triplu strat. Profile cu 5 sau 6 camere, feronerie premium inclusă.", detailsHu: "PVC ablakok kétrétegű vagy háromrétegű hőszigetelő üveggel. 5–6 kamrás profilok, prémium vasalattal." },
  { category: "windows" as Category, image: "https://images.unsplash.com/photo-1600566752355-35792bedcfea?w=500&h=400&fit=crop", detail: "https://images.unsplash.com/photo-1600566752355-35792bedcfea?w=800&h=600&fit=crop", nameKey: "windows" as const, detailsRo: "Ferestre din aluminiu cu rupere de punte termică. Rezistente la coroziune, ideale pentru construcții moderne.", detailsHu: "Hőhídmentes alumínium ablakok. Korrózióálló, modern épületekhez ideális." },
  { category: "doors" as Category, image: "https://images.unsplash.com/photo-1509644851169-2acc08aa25b5?w=500&h=400&fit=crop", detail: "https://images.unsplash.com/photo-1509644851169-2acc08aa25b5?w=800&h=600&fit=crop", nameKey: "doors" as const, detailsRo: "Uși de intrare din aluminiu sau PVC cu sistem antiefracție certificat. Umplutură termoizolantă.", detailsHu: "Alumínium vagy PVC bejárati ajtók tanúsított betörésálló rendszerrel. Hőszigetelő töltéssel." },
  { category: "doors" as Category, image: "https://images.unsplash.com/photo-1600585154526-990dced4db0d?w=500&h=400&fit=crop", detail: "https://images.unsplash.com/photo-1600585154526-990dced4db0d?w=800&h=600&fit=crop", nameKey: "doors" as const, detailsRo: "Uși interioare din MDF sau lemn masiv, bătante, glisante sau pliante. Gamă largă de culori.", detailsHu: "MDF vagy tömörfa belső ajtók, nyíló, toló vagy harmonika kivitelben. Széles szín- és mintaválaszték." },
  { category: "shutters" as Category, image: "https://images.unsplash.com/photo-1584622650111-993a426fbf0a?w=500&h=400&fit=crop", detail: "https://images.unsplash.com/photo-1584622650111-993a426fbf0a?w=800&h=600&fit=crop", nameKey: "shutters" as const, detailsRo: "Rulouri exterioare din aluminiu cu acționare manuală sau automată. Compatibile cu sisteme smart home.", detailsHu: "Kültéri alumínium redőnyök kézi vagy motoros működtetéssel. Okosotthon rendszerekkel kompatibilis." },
  { category: "shutters" as Category, image: "https://images.unsplash.com/photo-1524758631624-e2822e304c36?w=500&h=400&fit=crop", detail: "https://images.unsplash.com/photo-1524758631624-e2822e304c36?w=800&h=600&fit=crop", nameKey: "shutters" as const, detailsRo: "Jaluzele interioare și exterioare din lemn, aluminiu sau material textil. Sisteme personalizabile.", detailsHu: "Bel- és kültéri fa, alumínium vagy textil zsaluziák. Testre szabható árnyékolórendszerek." },
  { category: "mosquito" as Category, image: "https://images.unsplash.com/photo-1531390658687-6eba4bf70cc0?w=500&h=400&fit=crop", detail: "https://images.unsplash.com/photo-1531390658687-6eba4bf70cc0?w=800&h=600&fit=crop", nameKey: "mosquito" as const, detailsRo: "Plase de insecte fixe, rulante sau pliante. Cadre din aluminiu ușor, montaj rapid.", detailsHu: "Fix, feltekerhető vagy összehajtható szúnyoghálók. Könnyű alumínium keret, gyors szerelés." },
  { category: "mosquito" as Category, image: "https://images.unsplash.com/photo-1600047509358-9dc75507daeb?w=500&h=400&fit=crop", detail: "https://images.unsplash.com/photo-1600047509358-9dc75507daeb?w=800&h=600&fit=crop", nameKey: "mosquito" as const, detailsRo: "Accesorii și piese de schimb: mânere, balamale, garnituri. Service și înlocuire rapidă.", detailsHu: "Kiegészítők és cserealkatrészek: kilincsek, zsanérok, tömítések. Gyors szerviz és csere." },
];
          ...
          {filtered.map((p, i) => (
            ...
            >
              <div className="relative h-44 overflow-hidden">
                <Image src={p.image} alt={tr.products_preview[p.nameKey].name} fill className="object-cover hover:scale-105 transition-transform duration-300" unoptimized />
              </div>
              <div className="p-4">
                <h3 className="font-semibold text-gray-900 mb-1 text-sm">{tr.products_preview[p.nameKey].name}</h3>
        ...
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4" onClick={() => setSelected(null)}>
          <div className="bg-white rounded-2xl max-w-2xl w-full overflow-hidden shadow-2xl" onClick={(e) => e.stopPropagation()}>
            <div className="relative h-64">
              <Image src={selected.detail} alt={tr.products_preview[selected.nameKey].name} fill className="object-cover" unoptimized />
            ...
            <div className="p-6">
              <h2 className="text-xl font-bold text-gray-900 mb-3">{tr.products_preview[selected.nameKey].name}</h2>
