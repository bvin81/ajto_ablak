...
export default function Home() {
  ...
  const productList = [
    tr.products_preview.windows,
    tr.products_preview.doors,
    tr.products_preview.shutters,
    tr.products_preview.mosquito,
  ];
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {productList.map((p, i) => (
              <Link
                key={i}
                href="/produse"
                className="group bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-200 overflow-hidden"
              >
                ...
                <div className="p-5">
                  ...
                  <span className="text-sm font-medium group-hover:underline" style={{ color: "var(--clr-accent)" }}>
                    {tr.products_preview.details} →
                  </span>
                </div>
              </Link>
            ))}
